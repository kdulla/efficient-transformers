...
from transformers import AutoConfig, AutoProcessor, TextStreamer, AutoModelForImageTextToText
...
original_model = AutoModelForImageTextToText.from_config(config, attn_implementation="eager")

qeff_model = QEFFAutoModelForImageTextToText(original_model)
